...
if ($(".txtCell_txt").length !=0) { $(".txtCell_txt").css("background-color","rgba(255,255,255, 1)")}
if ($(".txtCell_input").length !=0) { $(".txtCell_input").css("background-color","rgba(255,255,255, 1)"); $(".txtCell_input").css("color",colorText);};
if ($(".txtCell_input").length !=0) {var color1="#FF0000";var color2="#FFFFFF";
$(".txtCell_input").css("background","-webkit-gradient(linear, left top, left bottom, from("+color1+"), to("+color2+"))");
$(".txtCell_input").css("background","-webkit-linear-gradient("+color1+", "+color2+")");
$(".txtCell_input").css("background","-moz-linear-gradient(top, "+color1+", "+color2+")");
$(".txtCell_input").css("background","-ms-linear-gradient("+color1+", "+color2+")");
$(".txtCell_input").css("background","-o-linear-gradient("+color1+", "+color2+")");
$(".txtCell_input").css("background","linear-gradient("+color1+", "+color2+")");
$(".txtCell_input").css("filter","progid:DXImageTransform.Microsoft.Alpha(startColorstr='"+color1+"', endColorstr='"+color2+"')");}
